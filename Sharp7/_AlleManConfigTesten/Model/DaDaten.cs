namespace _AlleManConfigTesten.Model
{
    public class DaDaten
    {
        ...
        public DaDaten(string datei, int laufendeNr, int startByte, int startBit, int anzahlBit, ManConfigTesten.PlcEinUndAusgaengeTypen type, string bezeichnung, string kommentar)
        {
            Dateiname = datei;
