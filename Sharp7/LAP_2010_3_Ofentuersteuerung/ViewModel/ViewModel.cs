namespace LAP_2010_3_Ofentuersteuerung.ViewModel
{
    ...
    public class ViewModel
    {
        ...
        // ReSharper disable once UnusedMember.Global
        public ICommand SetManualQ2 => _setManualQ2 ??= new RelayCommand(p => ViAnzeige.SetManualQ2(), p => true);
        ...
        // ReSharper disable once UnusedMember.Global
        public ICommand BtnS2 => _btnS2 ??= new RelayCommand(p => ViAnzeige.SetS2(), p => true);
        ...
        // ReSharper disable once UnusedMember.Global
        public ICommand BtnB3 => _btnB3 ??= new RelayCommand(p => ViAnzeige.SetB3(), p => true);
    }
}