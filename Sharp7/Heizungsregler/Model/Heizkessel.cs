namespace Heizungsregler.Model
{
    ...
    {
        private readonly Utilities.Pt1Zeitglied _kesselZeitglied;
        ...
        public Heizkessel() => _kesselZeitglied = new Utilities.Pt1Zeitglied(Zeitkonstante, Faktor,KesselMinTemperatur, KesselMaxTemperatur);
