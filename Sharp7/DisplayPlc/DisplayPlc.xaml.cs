...
public partial class DisplayPlc
{
    ...
    public void Start(Datenstruktur datenstruktur, Plc configPlc, BeschriftungenPlc beschriftungenPlc)
    {
    ...
    public DisplayPlc(Datenstruktur datenstruktur, Plc configPlc, BeschriftungenPlc beschriftungenPlc)
    {
        PlcAusgaenge = new Uint("16#FFFF");
        PlcEingaenge = new Uint("16#FFFF");
