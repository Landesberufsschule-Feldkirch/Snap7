...
namespace LAP_2010_1_Kompressoranlage.ViewModel
{
    ...
    public class ViewModel
    {
        ...
        public ICommand BtnF1 => _btnF1 ??= new RelayCommand(p => Kompressoranlage.BtnF1(), p => true);
        ...
        // ReSharper disable once UnusedMember.Global
        public ICommand BtnB1 => _btnB1 ??= new RelayCommand(p => Kompressoranlage.BtnB1(), p => true);
    }
}