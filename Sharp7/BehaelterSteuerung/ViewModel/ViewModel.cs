...
namespace BehälterSteuerung.ViewModel
{
    public class ViewModel
    {
        ...
        public ICommand BtnVentilQ2 => _btnVentilQ2 ?? (_btnVentilQ2 = new RelayCommand(p => _alleBehaelter.VentilQ2(), p => true));

        private ICommand _btnVentilQ4;
        // ReSharper disable once UnusedMember.Global
        public ICommand BtnVentilQ4 => _btnVentilQ4 ?? (_btnVentilQ4 = new RelayCommand(p => _alleBehaelter.VentilQ4(), p => true));

        private ICommand _btnVentilQ6;
        // ReSharper disable once UnusedMember.Global
        public ICommand BtnVentilQ6 => _btnVentilQ6 ?? (_btnVentilQ6 = new RelayCommand(p => _alleBehaelter.VentilQ6(), p => true));

        private ICommand _btnVentilQ8;
        // ReSharper disable once UnusedMember.Global
        public ICommand BtnVentilQ8 => _btnVentilQ8 ?? (_btnVentilQ8 = new RelayCommand(p => _alleBehaelter.VentilQ8(), p => true));
