...
namespace AmpelsteuerungKieswerk.Model
{
    ...
    public class LastKraftWagen
    {
        ...
        public LastKraftWagen(int id)
        {
            ...
            var yLkwParkposition = _parkpositionLinks.Y + id * (10 + _groesseLkw.Y);
            ...
            Position = new Rechteck(_parkpositionLinks, _groesseLkw.X, _groesseLkw.Y);
        }
        ...
        public (bool b1, bool b2, bool b3, bool b4) LastwagenFahren(bool stop)
        {
            ...
            switch (LkwPosition)
            {
                ...
                case LkwPositionen.LrLinkeKurve:
                    ...
                    Position.Punkt = _linkeKurve.PunktBestimmen(_kurvePosition);
