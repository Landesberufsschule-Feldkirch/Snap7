...
namespace LaborLinearantrieb.Model
{
    public class Linearantrieb
    {
        public bool B1 { get; set; }    // Linearantrieb Endlage links → Öffner
        public bool B2 { get; set; }    // Linearantrieb Endlage rechts → Öffner
        ...
        public Linearantrieb()
        {
            S2 = true;
            S9 = true;
            S10 = true;
            
            System.Threading.Tasks.Task.Run(LinearantriebTask);
        }

        private void LinearantriebTask()
        {
            while (true)
            {
