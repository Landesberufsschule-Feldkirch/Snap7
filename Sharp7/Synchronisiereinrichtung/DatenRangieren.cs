...
namespace Synchronisiereinrichtung
{
    public class DatenRangieren
    {
        ...
        public void RangierenInput(byte[] digInput, byte[] anInput)
        {
            ...
            S7.SetIntAt(anInput, 6, S7Analog.S7_Analog_2_Short(viewModel.Kraftwerk.Generator_P, 10000));
            ...
            S7.SetIntAt(anInput, 14, S7Analog.S7_Analog_2_Short(viewModel.Kraftwerk.Netz_P, 10000));
